...
const Auth = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = isLogin
      ? "https://lybrary2-0-1.onrender.com/api/auth/login"
      : "https://lybrary2-0-1.onrender.com/api/auth/signup";
  ...
  const handleGoogleLogin = async (credential) => {
    try {
      const res = await fetch("https://lybrary2-0-1.onrender.com/api/auth/google", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
